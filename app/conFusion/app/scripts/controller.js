...
angular.module('confusionApp')
        ...
        .controller('DishCommentController', ['$scope', 'menuFactory' ,
            ...
            $scope.newInput={ rating:1, comment:"", author:"",date:""};


            $scope.submitComment = function () {


                  $scope.newInput.date=new Date().toISOString();

                $scope.dish.comments.push($scope.newInput);
                ...
                .controller('IndexController',['$scope', '$stateParams', 'menuFactory', 'corporateFactory',
                              function($scope,$stateParams,menuFactory,corporateFactory){
                                   ...
                                   $scope.dishFirts = menuFactory.getDishes().get({id:0})
                                                      .$promise.then(
                                    ...
                                    $scope.promFirst=menuFactory.getPromotion(0);

                                    $scope.somayaPerson=corporateFactory.getLeader(3);
